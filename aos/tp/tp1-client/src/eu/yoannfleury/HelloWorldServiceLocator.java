...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements eu.yoannfleury.HelloWorldService {
    ...
    public eu.yoannfleury.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            eu.yoannfleury.HelloWorldSoapBindingStub _stub = new eu.yoannfleury.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (eu.yoannfleury.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                eu.yoannfleury.HelloWorldSoapBindingStub _stub = new eu.yoannfleury.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
